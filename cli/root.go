// Package cli builds the owasp command tree on top of the owasp library.
package cli
...
// App holds shared state for every subcommand.
type App struct {
	client *owasp.Client
	cfg    owasp.Config
...
func Root() *cobra.Command {
	app := &App{cfg: owasp.DefaultConfig()}

	root := &cobra.Command{
		Use:           "owasp",
		Short:         "Browse OWASP cheat sheets",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = owasp.NewClient(a.cfg)
	return nil
}
