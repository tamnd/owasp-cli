...
owasp is a single binary. It speaks to owasp over plain HTTPS,
shapes the responses into clean records, and gets out of your way. There is
nothing to sign up for and nothing to run alongside it.

## How it is built

- A **library package** (`owasp`) holds the HTTP client and the typed
...
owasp is a read-only client over data owasp already serves
